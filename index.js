...
let getYears = years.map(function(item){
    return (item['Year']);
});
...
let getWinnersByYear = finalOutput.forEach(function(key, i){
    //for (let i=0; i < newArr.length; i++) {
        return `In ${finalOutput.year}, ${finalOutput.country} won the world cup!`;
    });
//});
